...
/**
 * Request-scoped tenant context from {@code InternalAuthFilter} gateway headers.
 * See {@code com.um.security.BusinessContextHolder} for full semantics.
 */
public final class BusinessContextHolder {
	...
	/** True only for portal root admin ({@code tenantBypass} in JWT). */
