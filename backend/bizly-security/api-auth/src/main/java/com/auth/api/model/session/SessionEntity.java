package com.auth.api.model.session;
...
import com.auth.config.common.DatabaseConstants;

@Entity
@Table(name = DatabaseConstants.USER_SESSION_TABLE, schema = DatabaseConstants.SCHEMA)
